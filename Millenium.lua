    ...
    -- Library element functions
        function library:window(properties)
            ...
            local items = cfg.items; do
                ...
                items[ "other_info" ] = library:create( "TextLabel" , {
                    ...
                    TextColor3 = themes.preset.accent;
                    BorderColor3 = rgb(0, 0, 0);
                    Text = '<font color="rgb(72, 72, 73)">Welcome, </font>' .. cfg.name .. cfg.suffix;
                    Size = dim2(1, 0, 0, 0);
                    Position = dim2(0, -10, 0.5, -1);
                    AnchorPoint = vec2(0, 0.5);
                    BorderSizePixel = 0;
        ...
        function library:init_config(window) 
		    ...
		    section:button({name = "Save", callback = function() 
		        local config_name = flags["config_name_text"] ~= "" and flags["config_name_text"] or flags["config_name_list"]:sub(1, (flags["config_name_list"]:find(library.directory .. "/configs/", 1, true) or (#flags["config_name_list"] + 1)) - 1)
		    ...
		    section:button({name = "Load", callback = function() 
		        library:load_config(readfile(library.directory .. "/configs/" .. flags["config_name_list"]:sub(1, (flags["config_name_list"]:find(library.directory .. "/configs/", 1, true) or (#flags["config_name_list"] + 1)) - 1) .. ".cfg"))  
		        library:update_config_list() 
		        notifications:create_notification({name = "Configs", info = "Loaded config:\n" .. flags["config_name_list"]:sub(1, (flags["config_name_list"]:find(library.directory .. "/configs/", 1, true) or (#flags["config_name_list"] + 1)) - 1)}) 
		    end})
		    section:button({name = "Delete", callback = function() 
		        delfile(library.directory .. "/configs/" .. flags["config_name_list"]:sub(1, (flags["config_name_list"]:find(library.directory .. "/configs/", 1, true) or (#flags["config_name_list"] + 1)) - 1) .. ".cfg")  
		        library:update_config_list() 
