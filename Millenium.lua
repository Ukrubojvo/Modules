    ...
    -- Library element functions
        ...
        function library:init_config(window) 
		    ...
		    section:button({name = "Save", callback = function() 
		        local config_name = flags["config_name_text"] ~= "" and flags["config_name_text"] or flags["config_name_list"]:gsub(library.directory .. "/configs/.*", "")
		    ...
		    section:button({name = "Load", callback = function() 
		        library:load_config(readfile(library.directory .. "/configs/" .. flags["config_name_list"]:gsub(library.directory .. "/configs/.*", "") .. ".cfg"))  
		        library:update_config_list() 
		        notifications:create_notification({name = "Configs", info = "Loaded config:\n" .. flags["config_name_list"]:gsub(library.directory .. "/configs/.*", "")}) 
		    end})
		    section:button({name = "Delete", callback = function() 
		        delfile(library.directory .. "/configs/" .. flags["config_name_list"]:gsub(library.directory .. "/configs/.*", "") .. ".cfg")  
		        library:update_config_list() 
